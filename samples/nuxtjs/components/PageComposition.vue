...
import RelewiseProductRecommendations from "./relewiseProductRecommendations.vue";
import RelewiseContent from "./relewiseContent.vue";
...
const componentResolver = (component: ComponentInstance) => {
  ...
  if (component.type == "relewiseProductRecommendations") {
    return RelewiseProductRecommendations;
  }
  if (component.type == "relewiseContent") {
    return RelewiseContent;
  }
